...
namespace osu.Server.Spectator.Hubs.Spectator
{
    ...
    public interface IScoreProcessedSubscriber
    {
        ...
        ValueTask RegisterForNotificationAsync(string receiverConnectionId, int userId, long scoreId);
    }
    ...
    public delegate ValueTask ScoreProcessedAsyncCallback(string receiverConnectionId, int userId, long scoreId);
}
