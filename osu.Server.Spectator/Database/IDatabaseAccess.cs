...
namespace osu.Server.Spectator.Database
{
    public interface IDatabaseAccess : IDisposable
    {
        ...
        /// </summary>
        ValueTask<int?> GetUserIdFromTokenAsync(JsonWebToken jwtToken);

        /// <summary>
        /// Whether the user with the given <paramref name="userId"/> is currently restricted.
        /// </summary>
        ValueTask<bool> IsUserRestrictedAsync(int userId);
        ...
        /// </summary>
        ValueTask<multiplayer_room?> GetRoomAsync(long roomId);

        /// <summary>
        /// Retrieves a beatmap corresponding to the given <paramref name="beatmapId"/>.
        /// </summary>
        ValueTask<database_beatmap?> GetBeatmapAsync(int beatmapId);

        /// <summary>
        /// Marks the given <paramref name="room"/> as active and accepting new players.
        /// </summary>
        ValueTask MarkRoomActiveAsync(MultiplayerRoom room);

        /// <summary>
        /// Updates the current settings of <paramref name="room"/> in the database.
        /// </summary>
        ValueTask UpdateRoomSettingsAsync(MultiplayerRoom room);

        /// <summary>
        /// Updates the current host of <paramref name="room"/> in the database.
        /// </summary>
        ValueTask UpdateRoomHostAsync(MultiplayerRoom room);

        /// <summary>
        /// Add a new participant for the specified <paramref name="room"/> in the database.
        /// </summary>
        ValueTask AddRoomParticipantAsync(MultiplayerRoom room, MultiplayerRoomUser user);

        /// <summary>
        /// Remove a new participant for the specified <paramref name="room"/> in the database.
        /// </summary>
        ValueTask RemoveRoomParticipantAsync(MultiplayerRoom room, MultiplayerRoomUser user);
        ...
        ValueTask<multiplayer_playlist_item> GetPlaylistItemAsync(long roomId, long playlistItemId);

        /// <summary>
        /// Creates a new playlist item.
        /// </summary>
        /// <returns>The playlist item ID.</returns>
        ValueTask<long> AddPlaylistItemAsync(multiplayer_playlist_item item);

        /// <summary>
        /// Updates an existing playlist item.
        /// </summary>
        /// <param name="item">The new playlist item settings.</param>
        ValueTask UpdatePlaylistItemAsync(multiplayer_playlist_item item);
        ...
        ValueTask RemovePlaylistItemAsync(long roomId, long playlistItemId);

        /// <summary>
        /// Marks a playlist item as having been played.
        /// </summary>
        ValueTask MarkPlaylistItemAsPlayedAsync(long roomId, long playlistItemId);

        /// <summary>
        /// Marks the given <paramref name="room"/> as ended and no longer accepting new players or scores.
        /// </summary>
        ValueTask EndMatchAsync(MultiplayerRoom room);

        /// <summary>
        /// Retrieves all playlist items.
        /// </summary>
        /// <param name="roomId">The room to retrieve playlist items from.</param>
        ValueTask<multiplayer_playlist_item[]> GetAllPlaylistItemsAsync(long roomId);
        ...
        ValueTask<BeatmapUpdates> GetUpdatedBeatmapSets(int? lastQueueId, int limit = 50);

        /// <summary>
        /// Mark a score as having a replay available.
        /// </summary>
        /// <param name="score">The score to mark.</param>
        ValueTask MarkScoreHasReplay(Score score);
        ...
        /// </summary>
        ValueTask<phpbb_zebra?> GetUserRelation(int userId, int zebraId);
        ...
        /// </summary>
        ValueTask<bool> GetUserAllowsPMs(int userId);

        /// <summary>
        /// Returns all available main builds from the lazer release stream.
        /// </summary>
        ValueTask<IEnumerable<osu_build>> GetAllMainLazerBuildsAsync();

        /// <summary>
        /// Returns all known platform-specifc lazer builds.
        /// </summary>
        ValueTask<IEnumerable<osu_build>> GetAllPlatformSpecificLazerBuildsAsync();

        /// <summary>
        /// Updates the <see cref="osu_build.users"/> count of a given <paramref name="build"/>.
        /// </summary>
        ValueTask UpdateBuildUserCountAsync(osu_build build);
    }
}
